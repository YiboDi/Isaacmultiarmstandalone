...
class UR5View(ArticulationView):
    def __init__(
        ...
        self.shoulder_link = RigidPrimView(prim_paths_expr = prim_paths_expr + "/shoulder_link")
        self.upper_arm_link = RigidPrimView(prim_paths_expr = prim_paths_expr + "/upper_arm_link")
        self.forearm_link = RigidPrimView(prim_paths_expr = prim_paths_expr + "/forearm_link")
        self.wrist_1_link = RigidPrimView(prim_paths_expr = prim_paths_expr + "/wrist_1_link")
        self.wrist_2_link = RigidPrimView(prim_paths_expr = prim_paths_expr + "/wrist_2_link")
        self.wrist_3_link = RigidPrimView(prim_paths_expr = prim_paths_expr + "/wrist_3_link")
        ...
        self.ee = VisualCylinder(prim_path=prim_paths_expr + "/ee_link/ee", radius=0.02, height=0.1)
        self.target = VisualCylinder(prim_path=prim_paths_expr + "/target", radius=0.02, height=0.1,
                                    ...
                                    orientation=target_ori if target_ori is not None)
    ...
    def get_link_positions(self):
        ...
        for link in self.link_list:
            ...
            link_pos = list(link.get_world_poses())
            self.link_position += link_pos
